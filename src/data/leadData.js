...
var leadData = function (knex) {
                    ...
                    .then(function () {
                        return knex('party_supplemental_data')
                            ...
                            .insert({
                                ...
                                //the other three columns, were not to be populated here but in updatePSD.
                            })
                            .then(function () {
    ...
    var getLeadById = function (id) {
        return knex.select('person.party_id', 'person.salutation', 'person.first_name', 'person.middle_name',
            ...
            // (next line) Left join would often result to a contactMech array with one empty (except datetime) contactMech
