...
var PartySupplementalDiv = require('../../leads/create-lead/PartySupplementalDiv');
...
<div className="form-group col-lg-6">
  ...
  <div className="col-sm-12 col-lg-6">
    <div className="input-group">
      ...
      <select id="SelectCurrencyUom" name="SelectCurrencyUom" className="form-control input-md" style="display: inline-block; ">
