...
var AddItemForm = React.createClass({
    ...
    componentDidMount: function() {
        ...
        $('#addItemForm').validator().on('submit', function (e) {
            if (e.isDefaultPrevented()) {
                ...
                // thisAddItemForm.props.onFormSubmit(e);  // THIS IS HOW WE DID IT WHEN IN A CHILD COMPONENT
                console.log('reached else block after form validation');
                thisAddItemForm._addQuoteItem();  // IS THIS THE WAY TO DO IT HERE?
            }
        });
    ...
    _addQuoteItem: function(event) {
        // HOW EXACTLY TO REACH HERE-- DID I DO IT WITH JQUERY ABOVE?
        console.log('_addQuoteItem, sending out this.state.quoteItem = ', this.state.quoteItem);
