                    ...
                    <div className="col-lg-6 col-xs-12">
                        <div className="form-group">
                            ...
                            <div className="input-group">
                                ...
                                <input type="text" className="form-control" id="annualRevenue" placeholder="Annual revenue" />
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6 col-xs-12">
                        <div className="form-group">
                            ...
                            <div className="input-group">
                                <div className="input-group-addon"><i className="fa fa-file-text-o" aria-hidden="true"></i></div>
                                <input type="text" className="form-control" id="numEmployees" placeholder="Number of Employees" />
                            </div>
                        </div>
                    </div>
                </div>
